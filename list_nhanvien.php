...
echo "<tr><th>Mã nhân viên</th><th>Tên nhân viên</th><th>Phái</th><th>Nơi sinh</th><th>Mã phòng</th><th>Lương</th><th>Action</th></tr>";
...
for ($i = $viTriBatDau; $i < $viTriKetThuc; $i++) {
    ...
    if ($item["Phai"] == 'nam') {
        echo "<img src='men.png' width='50' height='50' />";
    } else {
